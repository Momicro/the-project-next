  ...
  if (type === "profile") {
    return (
      ...
      >
        ...
        <CldUploadWidget onSuccess={onUpload} uploadPreset="CloudPreset">
          {({ open }) => {
            const onClick = () => {
              open();
            };
            ...
            return (
              <>
                <button
                  type="button"
                  className="z-20 absolute right-0 bottom-6 flex items-center font-medium text-[17px] h-14 w-14 justify-center text-white bg-gradient-to-t from-blue-primary to-blue-500 border-none shadow-lg rounded-full hover:shadow-md active:shadow-sm"
                  disabled={disabled}
                  onClick={onClick}
                >
                  <svg
