...
const CategoryDetails: FC<CategoryDetailsProps> = ({ data }) => {
  ...
  > = async (values) => {
    try {
      console.log("getValues()=====================>:", form.getValues()); // <-- hier hinzufügen
      console.log("Submitted values=====================>:", values);
      const { name, image, url, featured } = form.getValues();
      ...
      console.log("Incoming category=====================> ", values);
      ...
      toast({
        variant: "destructive",
        title: "Oops! Error creating/updating category",
        description:
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-1">
                    ...
                    <FormControl>
                      <Input placeholder="/category-url" required {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
